...
String formatDuration(Duration duration) { // as: hh/mm
...
String convertCitiesEnumsToHebrew(Cities cityToConvert) { // from Cities.Jerusalem --> ירושלים
  print("city index: " + cityToConvert.index.toString() + ", value: " + cityToConvert.toString());
...
void switchColorOfCityChosenForError() {
  if(globals.defaultCity == Cities.None || globals.borderOfCityChosenColor == Colors.red) { // exclude the case after choosing city the border will remain red
